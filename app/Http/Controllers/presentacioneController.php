...
->with('sucess','Presentacione registrada');
    }
    ...
    public function update(UpdatePresentacioneRequest $request, Presentacione $presentacione)
    {
        ...
        return redirect()->route('presentaciones.index')->with('success','Presenciones Editada');
 ...
 if($presentacione->caracteristica->estado == 1){
     Caracteristica::where('id',$presentacione->caracteristica->id)
     ->update(['estado' => 0]);
     $message='Presentacione eliminada';
 }else{
     Caracteristica::where('id',$presentacione->caracteristica->id)
     ->update(['estado' => 1]);
     $message='Presentacione restaurada';
        ...
        return redirect()->route('presentaciones.index')->with
        ('success',$message);
