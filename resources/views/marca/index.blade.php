...
<div class="container-fluid px-4">
    ...
    <a href="{{route('marcas.create')}}"><button type='button'
  ...
  <button type="button" class="btn btn-danger deleteButton" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$marca->id}}" >Borrar</button>

  @else
  <button type="button" class="btn btn-danger deleteButton" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$marca->id}}" >Restaurar</button>
