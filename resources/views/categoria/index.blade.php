...
<div class="container-fluid px-4">
    ...
    <a href="{{route('categorias.create')}}"><button type='button'
  ...
  <button type="button" class="btn btn-danger deleteButton" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$categoria->id}}" >Borrar</button>

  @else
  <button type="button" class="btn btn-danger deleteButton" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$categoria->id}}" >Restaurar</button>
